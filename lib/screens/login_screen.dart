...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void onLoginSuccess() async {
    ...
    try {
      print('[LoginScreen] Loading user data...');
      
      // Load all user data (no need for userID now)
      ...
      // Navigate to main screen (no arguments needed)
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Icon(Icons.draw, size: 80, color: Colors.blue[700]),
                  const SizedBox(height: 16),
